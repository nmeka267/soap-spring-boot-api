package com.bankingg.spring.soap.api.config;
...
public class SoapWSConfig {
	...
	public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema schema) {
		...
		defaultWsdl11Definition.setLocationUri("/webservice");
		defaultWsdl11Definition.setTargetNamespace("http://www.bankingg.com/spring/soap/api/loanEligibility");
